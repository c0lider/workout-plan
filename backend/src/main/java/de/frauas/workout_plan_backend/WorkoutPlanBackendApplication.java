...
public class WorkoutPlanBackendApplication {
	...
	CommandLineRunner runner(UserRepository userRepository, ExerciseRepository exerciseRepository,
							 WorkoutPlanRepository workoutPlanRepository, UserSettingsRepository userSettingsRepository,
		...
		return args -> {
			...
			UserEntity user2 = new UserEntity(2, "LeBrob", "Lemax.Lesmoritsz@interia.pl", "5432s1");
			...
			WorkoutPlanExerciseEntity planExerciseEntity = new WorkoutPlanExerciseEntity(1, 10, 3, 60);
